...
function BaseNppkb() {
  return (
    <div className={"dokumen__nppkb body--xsmall"}>
      {/* First Section */}
      <table className="text-uppercase w-100">
        <tbody>
          ...
          <tr>
            <td className="text-center">NOTA PERHITUNGAN PAJAK KENDARAAN BERMOTOR (NPPKB) </td>
          </tr>
          <tr>
  ...
  <tbody>
    ...
    <tr>
      <td colSpan={7} className="text-center">
        <hr className="mb-1 mt-1" style={{ border: "none", borderTop: "1.5px dashed #1a4373" }} />
      </td>
    </tr>
    <tr>
      <td>JUMLAH</td>
    ...
    <tr>
      <td colSpan={7} className="text-center">
        <hr className="mt-1 mb-1" style={{ border: "none", borderTop: "1.5px dashed #1a4373" }} />
      </td>
    </tr>
  </tbody>
</table>
      ...
      <table>
        <tbody>
          <tr>
            ...
            <td colSpan={2} className="body--xsmall">DUMMY_PLACE, DATE</td>
          </tr>
          <tr>
            <td className="body--xsmall">PETUGAS PENETAPAN</td>
            <td className="body--xsmall">:</td>
            <td colSpan={2} className="body--xsmall">DUMMY_OFFICER</td>
          </tr>
          <tr>
            <td>.</td>
            <td>.</td>
